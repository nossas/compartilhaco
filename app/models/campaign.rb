class Campaign < ActiveRecord::Base
  ...
  validates :ends_at, :share_link, :goal, :organization_id, :user_id, :category_id, :image, :title, :description, :short_description, :share_description, :tweet, :new_campaign_spreader_mail, presence: true
